...
WebUI.setText(findTestObject('Amazon/TC_Amazon_002_ItemSearch/Page_Online Shopping site in India Shop Online for Mobiles, Books, Watches, Shoes and More - Amazon.in/input_Search Amazon.in_field-keywords'), 
    items)
...
WebUI.verifyTextPresent(items, true)
